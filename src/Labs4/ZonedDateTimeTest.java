...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
        ...
        LocalDateTime dateTime = LocalDateTime.of(2015,7,10,2,14,25,0);
        return ZonedDateTime.of(dateTime,ZoneId.of("Asia/Tokyo"));
    }
    ...
    static ZonedDateTime zonedDateTimeParse() {
        ...
        String dateTimeString = "2015-06-18T23:07:25.000";
        LocalDateTime dt = LocalDateTime.parse(dateTimeString,DateTimeFormatter.ISO_LOCAL_DATE_TIME);

        return ZonedDateTime.of(dt, ZoneId.of("Asia/Tokyo"));
    }
